...
function misturar (){
    ...
    if (MINUSCULA_ELEMENTO.checked){
        ELEMENTOS.push(sortear_minuscula())
   }


    if (NUMEROS_ELEMENTO.checked){
        ELEMENTOS.push(sortear_numeros())
   }


    if (CARACTERES_ELEMENTO.checked){
        ELEMENTOS.push(sortear_caracteres())
    }
